# Extended from: https://github.com/mlmed/torchxrayvision/blob/master/scripts/train_utils.py
import os, copy
import pickle
import pprint
import random
...
def train(model, dataset, cfg):
    ...
    # Dataset    
    gss = sklearn.model_selection.GroupShuffleSplit(train_size=0.9,test_size=0.1, random_state=cfg.seed)
